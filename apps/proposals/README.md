...
| `NOTIFY_WEBHOOK_URL` | (none; log only)           | Pinged on viewed / accepted / declined. A Discord webhook URL gets a formatted message; anything else gets raw JSON |
